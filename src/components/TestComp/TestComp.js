    ...
    <div className="w3-card-2 w3-padding cardheight w3-round w3-white">
      ...
      <form>
        ...
        <label> Enter your Length:
          <input type="text" value={length} onChange={(e) => setLength(e.target.value)} /> <br />
        </label>

        <br />

        <label> Enter your Width:
      ...
      <form>
        <br /> <br />
        <textarea value={textarea} onChange={(event) => handleChangetextarea(event)} />
        <br />
